    ...
    <form ref={formRef} onSubmit={onSubmit} className="space-y-5">
      ...
      <div>
        ...
        <button
          ...
          className="mt-1 inline-flex items-center gap-2 rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm font-medium text-zinc-700 shadow-sm hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-violet-700"
        >
          + Add files
        </button>
