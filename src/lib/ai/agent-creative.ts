...
VERIFY YOUR WORK: Before outputting, count the photos in each page's selectedImages array. Cover ≤1, each middle page 3-6, closing ≤1. If any middle page has fewer than 3, redistribute from other pages or add more from the curated list.
