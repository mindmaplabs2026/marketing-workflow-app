...
- Whether this is a single poster or carousel (4-5 pages).
...
RULES for carousel:
PAGE COUNT:
- Carousel MUST have exactly 4 or 5 pages. Decide based on how many uploaded photos are available:
  - 1-8 photos → 4 pages
  - 9+ photos → 5 pages
  - 0 photos (event-based) → 4 pages
...
- PAGE 1 (Cover): Attention-grabbing cover with the main headline. Use 0-1 uploaded photos MAXIMUM. A creative cover with zero photos and strong typography is preferred. If one photo is used, it should be a hero group shot.
- MIDDLE PAGES (pages 2, 3, and optionally 4): These are the PHOTO SHOWCASE pages. Each middle page MUST include 3-6 uploaded photos in a collage/grid layout. This is where ALL the uploaded photos go. Distribute photos evenly across middle pages. Use creative layouts: 2x2 grids, 3-column strips, staggered overlapping, mosaic patterns.
- LAST PAGE (Closing): Call to action / wrap-up page. Use 0-1 uploaded photos MAXIMUM. Focus on: school contact details, tagline, CTA text. Can include small icons or decorative elements.
...
## Poster type: ${input.posterType}${input.posterType === "carousel" ? " (4-5 pages)" : ""}
